...
$('#buscador').on('keyup','input',function(){
  var padre_buscador = $(this).parents('div#buscador');
  ...
  $.ajax({
    ...
    success:function(resp){
      $('.lista_usuarios').html(resp);
    }
  });
});

// paginacion
$(document).on('click','#paginacion_usuarios .pagination a',function(e){
  e.preventDefault();
