  ...
  @for($mes = 1 ; $mes <=12 ;$mes++)
    ...
    <table  border="1">
      ...
      <tbody>
        ...
        @if($contador_existencia[$area->id][$mes][$personalarea->id] != 30)
        <tr>
          <td>{{ $i++ }}</td>
          ...
          @for($dia = 1 ; $dia<=30 ;$dia++)
            ...
            @endif
          @endfor
          <td>{{$contador_asistencias[$area->id][$mes][$personalarea->id]}}</td>
          <td>{{$contador_faltas[$area->id][$mes][$personalarea->id]}}</td>
          <td>{{$contador_permisos[$area->id][$mes][$personalarea->id]}}</td>
          <td>{{$contador_vacaciones[$area->id][$mes][$personalarea->id]}}</td>
          <td>30</td>
        </tr>
        @endif
        @endforeach
