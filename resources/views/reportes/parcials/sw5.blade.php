<h4 class="area">(CORRESPODIENTE AL AÑO {{$valor_anio}})</h4>
...
@for($mes = 1 ; $mes <= 12 ;$mes++)
  ...
  <table  border="1">
    ...
    <tbody>
      ...
      @if($contador_existencia[$mes][$personalarea->id] != 30)
      <tr>
        <td>{{ $i++ }}</td>
        ...
        @for($dia = 1 ; $dia<=30 ;$dia++)
          ...
          @endif
        @endfor
        <td>{{$contador_asistencias[$mes][$personalarea->id]}}</td>
        <td>{{$contador_faltas[$mes][$personalarea->id]}}</td>
        <td>{{$contador_permisos[$mes][$personalarea->id]}}</td>
        <td>{{$contador_vacaciones[$mes][$personalarea->id]}}</td>
        <td>30</td>
      </tr>
      @endif
      @endforeach
