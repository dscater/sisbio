...
<table  border="1">
  ...
  <tbody>
    ...
    @if($contador_existencia[$personalarea->id] != 30)
    <tr>
      <td>{{ $i++ }}</td>
      ...
      @for($dia = 1 ; $dia<=30 ;$dia++)
        ...
        @endif
      @endfor
      <td>{{$contador_asistencias[$personalarea->id]}}</td>
      <td>{{$contador_faltas[$personalarea->id]}}</td>
      <td>{{$contador_permisos[$personalarea->id]}}</td>
      <td>{{$contador_vacaciones[$personalarea->id]}}</td>
      <td>30</td>
    </tr>
    @endif
    @endforeach
