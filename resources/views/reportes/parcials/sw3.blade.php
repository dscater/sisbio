  ...
  @for($mes = 1 ; $mes <= 12 ;$mes++)
    ...
    <table  border="1">
      ...
      <tbody>
        ...
        @if($contador_existencia[$anio][$mes][$personalarea->id] != 30)
        <tr>
          <td>{{ $i++ }}</td>
          ...
          @for($dia = 1 ; $dia<=30 ;$dia++)
            ...
            @endif
          @endfor
          <td>{{$contador_asistencias[$anio][$mes][$personalarea->id]}}</td>
          <td>{{$contador_faltas[$anio][$mes][$personalarea->id]}}</td>
          <td>{{$contador_permisos[$anio][$mes][$personalarea->id]}}</td>
          <td>{{$contador_vacaciones[$anio][$mes][$personalarea->id]}}</td>
          <td>30</td>
        </tr>
        @endif
        @endforeach
