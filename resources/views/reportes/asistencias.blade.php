...
<body>
  ...
  <div id="encabezado">
    ...
    @if($sw == 1)
      <h4>(CORRESPODIENTE A TODOS LOS MESES Y AÑOS)</h4>
    @endif
    @if($sw == 2 || $sw == 6)
    <h4>(CORRESPODIENTE AL MES DE {{$array_mes_pdf[$valor_mes]}} DEL AÑO {{$valor_anio}})</h4>
    @endif
    @if($sw == 7)
    <h4>(CORRESPODIENTE AL AÑO {{$valor_anio}})</h4>
    @endif
  </div>
