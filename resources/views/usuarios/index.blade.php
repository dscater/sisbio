...
@endif
    ...
    <div class="panel panel-default tabla">
        <div class="panel-heading">
          <a href="{{ route('users.create') }}" class="btn btn-primary pull-right">Registrar usuario</a>
          <h4>Usuarios</h4>
        </div>
        <div class="panel-body">
          <div class="row" id="buscador">
            <input type="text" class="url_index" value="{{ route('users.index') }}" hidden>
            <div class="col-md-12">
              <h4><i class="fa fa-search"></i> Buscar usuario:</h4>
            </div>
...
<script src="{{ asset('js/buscar_usuario.js') }}"></script>
@endsection
