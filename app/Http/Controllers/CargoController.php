...
class CargoController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($nombre_comprobar) {
      return redirect()->route('cargos.create')->with(
        'msg',
    ...
    RegistroLog::create([
      ...
      "modulo" => "CARGOS",
      "accion" => "REGISTRO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " REGISTRO UN CARGO",
    ]);

    return redirect()->route('cargos.edit', $cargo->id)->with(
      'msg',
  ...
  public function update(Request $request, Cargo $cargo)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "CARGOS",
      "accion" => "ACTUALIZO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ACTUALIZO UN CARGO",
    ]);
    return redirect()->route('cargos.edit', $cargo->id)->with(
      'msg',
      '<div class="alert alert-success">
  ...
  public function destroy(Cargo $cargo)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "CARGOS",
      "accion" => "ELIMINO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ELIMINO UN CARGO",
    ]);
    return redirect()->route('cargos.index')->with(
      'msg',
      '<div class="alert alert-success">
          <button class="close" data-dismiss="alert">&times;</button>
