...
class DatosUsuarioController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('users.edit', $datosUsuario->id)->with(
      'msg',
  ...
  public function update(Request $request, DatosUsuario $datosUsuario)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "USUARIOS",
      "accion" => "ACTUALIZO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ACTUALIZO UN USUARIO",
    ]);
  ...
  public function destroy(User $user)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "USUARIOS",
      "accion" => "ELIMINO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ELIMINO UN USUARIO",
    ]);
