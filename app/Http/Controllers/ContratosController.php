...
class ContratosController extends Controller
{
  ...
  public function store(Request $request, $id)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "CONTRATOS",
      "accion" => "REGISTRO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " REGISTRO UN CONTRATO",
    ]);
  ...
  public function update(Request $request, Contratos $contrato)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "CONTRATOS",
      "accion" => "ACTUALIZO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ACTUALIZO UN CONTRATO",
    ]);
  ...
  public function destroy(Contratos $contrato)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "CONTRATOS",
      "accion" => "ELIMINO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ELIMINO UN CONTRATO",
    ]);
