...
class FormacionPersonalController extends Controller
{
  ...
  public function store(Request $request, $id)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "FORMACIÓN DE PERSONAL",
      "accion" => "REGISTRO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " REGISTRO UNA FORMACIÓN DE PERSONAL",
    ]);
  ...
  public function update(Request $request, FormacionPersonal $formacion)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "FORMACIÓN DE PERSONAL",
      "accion" => "ACTUALIZO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ACTUALIZO UNA FORMACIÓN DE PERSONAL",
    ]);
  ...
  public function destroy(FormacionPersonal $formacion)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "FORMACIÓN DE PERSONAL",
      "accion" => "ELIMINO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ELIMINO UNA FORMACIÓN DE PERSONAL",
    ]);
