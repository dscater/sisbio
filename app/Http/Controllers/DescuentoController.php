...
class DescuentoController extends Controller
{
  ...
  public function store(Request $request, $id)
  {
    ...
    if (count($existencia_pago) == 0) {
      ...
      RegistroLog::create([
        ...
        "modulo" => "DESCUENTOS",
        "accion" => "REGISTRO",
        "descripcion" => "EL USUARIO " . Auth::user()->name . " REGISTRO UN DESCUENTO",
      ]);
  ...
  public function update(Request $request, Descuento $descuento)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "DESCUENTOS",
      "accion" => "ACTUALIZO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ACTUALIZO UN DESCUENTO",
    ]);
  ...
  public function destroy(Descuento $descuento)
  {
    ...
    RegistroLog::create([
      ...
      "modulo" => "DESCUENTOS",
      "accion" => "ELIMINO",
      "descripcion" => "EL USUARIO " . Auth::user()->name . " ELIMINO UN DESCUENTO",
    ]);
