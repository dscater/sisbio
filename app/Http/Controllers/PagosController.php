...
class PagosController extends Controller
{
    ...
    public function create($id)
    {
      ...
      if(empty($contrato))
      {
        ...
        return view('pagos.create',compact('id','personal','array_anios',
        'anio_actual','array_mes','mes_actual','empresa','contrato',
        'afps','comision_afps','fondo_solidario','riesgo_comun'));
      }
    }
    ...
    // CALCULOS PARA LA BOLETA
      ...
      $pdf = PDF::loadView('pagos.pdf.boleta_pago',
      compact('personal','empresa','afps','comision_afps','mes','anio','pago',
              'fondo_solidario','riesgo_comun','contrato','array_cargos','array_areas',
              'afps_porcent','comision_afps_porcent','fondo_solidario_porcent','riesgo_comun_porcent',
              'total_extra_horas','total_extra_otros','total_descuento_anticipos','total_descuento_otros',
